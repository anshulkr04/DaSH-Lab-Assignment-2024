...
DIR_PATH="Desktop/DD/DaSH-Lab-Assignment-2024/Development/Level-2"
...
run_client() {
    ...
    tell application "Terminal"
        do script "cd Desktop;cd DaSH-Lab-Assignment-2024;source .venv/bin/activate;cd Development;cd Level-2; python3 '$SCRIPT_NAME'"
    end tell
EOF
}
